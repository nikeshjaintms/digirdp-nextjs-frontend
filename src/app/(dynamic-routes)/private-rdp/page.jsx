                ...
                <div className="row">
                  <div className="col-lg-12">
                    <div className="section-title text-center">
                      <h2 className="title w-600 mb--20">RDP By Location</h2>
                      <p>
                        Here for RDP? Look no where else, we will setup Windows
                        RDP tailored to your needs no matter the scale
                      </p>
                    </div>
                  </div>
                </div>
                      ...
                      {rdp_location.map((rdp, index) => (
                        ...
                        >
                          <div className="rainbow-box-card active card-style-default testimonial-style-defalt has-bg-shaped">
                            <Link href={`/private-rdp/${rdp.url_text}`}>
