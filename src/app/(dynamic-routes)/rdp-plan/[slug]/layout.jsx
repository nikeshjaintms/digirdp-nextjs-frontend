...
export async function generateMetadata({ params }) {
  ...
  const cononicalUrl = slug ? `/rdp-plan/${slug}` : "/rdp-plan"
  ...
  return {
    ...
    openGraph: {
          title: rdp?.og_title || "RDP VPS Server", // Assuming rdp might have og_title
          description: rdp?.og_description || "RDP VPS Server Description", // Assuming rdp might have og_description
          url: `https://digirdp.com${cononicalUrl}`, // Use the dynamic canonical URL here
          siteName: "DigiRDP",
          images: [
            {
