...
async function getRdpPlanData() {
  try {
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/windows_rdps`,
      {
    ...
    if (!response.ok) {
      throw new Error("Failed to fetch pdp plan data");
    }
...
export default async function Rdp() {
  const rdps = await getRdpPlanData(); // Fetch rdp data on the server

  if (!rdps) {
    return <div>Rdps not found.</div>; // Handle case where rdps data is not available
  }
              ...
              <div className="col-lg-12">
                <div className="breadcrumb-inner text-center">
                  ...
                  <p className="description b1">
                    Explore our range of categories and choose the perfect plan
                ...
                <div className="row">
                  <div className="col-lg-12">
                    <div className="section-title text-center">
                      ...
                      <p>
                        Looking for RDP? You’re in the right place! We provide
                        customized Windows RDP solutions to match your
                        requirements, no matter the scale.{" "}
                      </p>
                    </div>
                  </div>
                </div>
                                  ...
                                  <div className="bottom-content">
                                    <div className="meta-info-section">
                                      <div className="desc-img">
                                        <img
                                          src={`${process.env.NEXT_PUBLIC_BACKEND_IMAGE_URL}/${rdp.logo}`}
                                          alt="brang"
                                          style={{
                                            borderRadius: "50px",
                                            width: "40px",
